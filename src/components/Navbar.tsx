    ...
    <div className="fixed top-6 left-0 right-0 z-[100] flex justify-center px-4">
      ...
      >
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 bg-primary rounded-full flex items-center justify-center text-white font-headline text-sm font-bold shadow-lg shadow-primary/20">
            YK
          </div>
          <div className="hidden sm:flex flex-col">
            <span className="font-headline text-sm text-[#4A4A4A] tracking-tighter font-extrabold uppercase leading-none">
              Yadu Krishnan
            </span>
            <span className="text-[8px] font-bold tracking-[0.2em] text-primary uppercase opacity-60">
        ...
        <div className="hidden lg:flex items-center gap-10 text-xs font-bold uppercase tracking-widest text-[#4A4A4A]/60">
          <a href="#creative" className="hover:text-primary transition-colors hover:tracking-[0.2em] duration-300">Skills</a>
          <a href="#tech" className="hover:text-primary transition-colors hover:tracking-[0.2em] duration-300">Experience</a>
        ...
        <div className="flex items-center gap-6">
          <div className="hidden md:flex items-center gap-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-tighter opacity-70">Available Now</span>
          </div>
